             ...
             <li className="collection-item avatar">
              ...
              style={{"bottom": "45px; right: 24px;"}}>
                    ...
                    <ul>
                       ...
                       <li>
                          <a href ='/upload' class="btn-floating green darken-1 btn tooltipped"data-position="bottom" data-tooltip="Add a new File">
                            <i class="material-icons">create_new_folder</i>
                         </a>
                       </li>

                       <li>
                          <a href ={file.downloadURL} class="btn-floating btn tooltipped yellow " data-position="bottom" data-tooltip="Download File">
