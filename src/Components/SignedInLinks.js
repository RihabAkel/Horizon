  ...
  return (
    <div>
      <ul className="right">
        ...
        <li><NavLink to='#!' className="btn btn-floating waves-light yellow darken-3 " > {this.props.profile.initials}</NavLink></li>
        <li>
              ...
              <li>
                 <div class="user-view">
                        ...
                        <a class="btn-floating halfway-fab waves-effect waves-light black btn tooltipped"data-position="bottom" data-tooltip="Add a new profile picture" ><i class="material-icons">add_a_photo</i></a>
                   ...
                   <li><a class="waves-effect" href="#!"><i class="material-icons ">monetization_on</i>Horizon premium services</a></li>
